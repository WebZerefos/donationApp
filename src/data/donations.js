export const items = [
	{
		...
		description: 'A lantern powered by solar energy, providing a sustainable and eco-friendly source of light to those in need.',
		image:
	...
	},
	{
		...
		description: 'A warm winter coat to protect people from the cold and help them stay warm during the winter months.',
		image:
	...
	},
	{
		...
		description: 'Laptops for underprivileged students to help them access technology and participate in virtual learning.',
		image:
	...
	{
		name: 'Board games',
		description: 'Board games for families and children to play and enjoy together, promoting social interaction and entertainment.',
		image:
	...
	{
		name: 'Basketballs',
		description: 'Basketballs for children to play and stay active, promoting physical fitness and exercise.',
		image:
	...
	},
	{
		...
		description: 'Children’s books to promote literacy and encourage a love for reading in young children.',
		image:
	...
	{
		name: 'Power tools',
		description: 'Power tools such as drills and saws for people in need to complete home improvement projects and repairs.',
		image:
	...
	{
		name: 'Art supplies',
		description: 'Art supplies, such as paints, brushes, and canvas, for people to express their creativity and participate in art activities.',
		image:
	...
	},
	{
		...
		description: 'Eco-friendly water bottles made from reusable materials to reduce waste and promote sustainability.',
		image:
	...
	},
	{
		...
		description: 'Music instruments, such as guitars and keyboards, for people to learn and enjoy playing music.',
		image:
	...
	{
		name: 'Blankets',
		description: 'Blankets to provide warmth and comfort to those in need, especially during cold weather.',
		image:
	...
	},
	{
		...
		description: 'Non-perishable food, such as canned goods and rice, to provide essential sustenance to those in need.',
		image:
	...
	},
	{
		...
		description: 'Books for people of all ages, promoting literacy and a love for reading.',
		image:
